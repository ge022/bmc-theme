	...
	<div class="tribe-events-organizer">
      ...
      <section class="main">
        ...
        <div class="event-header">
          ...
          <h2 class="tribe-organizer-name"
              style="<?php if ( has_post_thumbnail() ) { echo 'position: absolute;'; } ?>">
      ...
      <aside class="sidebar">
        ...
        <div class="tribe-events-single-section-title"><?php echo __( 'Contact Information', 'bmc-theme' ) ?></div>
        
        <div class="organizer-address">
          
          <?php if ( $organizer_id && $tel = tribe_get_organizer_phone() ) : ?>
            <div>
          ...
          <?php if ( $organizer_id && $email = tribe_get_organizer_email() ) : ?>
            <div>
              <div class="email"><?php echo __( 'Email', 'bmc_theme' ); ?></div>
              <?php echo '<a href="mailto:' . esc_attr( $email ) . '">' . $email . '</a>' ?>
            </div>
          <?php endif; ?>
          
          <?php if ( $organizer_id && $link = tribe_get_organizer_website_link() ) : ?>
            <div>
              <div class="link"><?php echo __( 'Website', 'bmc_theme' ); ?></div>
              <?php echo $link ?>
            </div>
          <?php endif; ?>
