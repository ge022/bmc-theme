...
<ul class="tribe-events-sub-nav">
	...
	<li class="tribe-events-nav-previous" aria-label="previous day link"><?php tribe_the_day_link( 'previous day', 'Previous Day' ) ?></li>

	<!-- Next Page Navigation -->
	<li class="tribe-events-nav-next" aria-label="next day link"><?php tribe_the_day_link( 'next day', 'Next Day' ) ?></li>
